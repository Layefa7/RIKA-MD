...
let cc = Config.sessionName.replace(/RIKA;;;/g, "").replace(/RIKA;;;/gi, ""); // DONT REMOVE BLACK;;; so you can connect RIKA md session id too
                        ...
                        if (citel.isGroup && !isAdmins && mongoschema == 'true') {
                            ...
                            array.map(async(bg) => {
                                ...
                                if (pattern.test(chab)) {
                                    if (!isBotAdmins) {
                                        let buttonMessage = {
                                            text: `* •Link has been detected with evidence• *
